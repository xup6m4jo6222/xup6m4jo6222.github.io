...
date: 2026-07-16
cover: /images/portfolio-site/current-v9.png
---
...
<figure class="cs-wipe" style="margin:0">
  ...
  <div class="cs-wipe-top">
    <img src="/images/portfolio-site/current-v9.png" alt="現行首頁，第9版視覺" width="760" height="470" />
  </div>
  <input type="range" min="0" max="100" value="55" aria-label="拖曳比對兩個版本" />
  <div class="cs-wipe-handle"></div>
  <span class="cs-wipe-tag cs-wipe-tag--new" style="left:0.6rem;right:auto">最終版 2026-07-28 第9版</span>
...
<ul class="tl">
  ...
  <li class="tl-item" data-focus-group>
    ...
    <figure class="cs-wipe cs-wipe--embed" style="margin:0">
      ...
      <div class="cs-wipe-top">
        <img src="/images/portfolio-site/page-timeline-v9.png" alt="現行時間軸版" width="760" height="470" loading="lazy" />
      </div>
      <input type="range" min="0" max="100" value="55" aria-label="拖曳比對兩個版本" />
      <div class="cs-wipe-handle"></div>
      <span class="cs-wipe-tag cs-wipe-tag--new" style="left:0.6rem;right:auto">時間軸版 2026-07-28 第9版</span>
...
<script>
/* 只剩比對器滑桿——它確實只有這一頁有。聚焦組的觀察器已搬到五個專案內頁共用的版型層。 */
(() => {
  function init() {
